...
theta        = 0.25;  % threshold of the hard clipping
...
simulate     = false; % use simulated signal?
plottime     = false; % use time as horizontal axis in plots
segmentation = true;  % process the signal segment-wise
...
[signal, fs] = audioread("speech/p232_030.wav");
N = length(signal);
